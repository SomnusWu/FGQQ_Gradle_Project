...
public class AutoLoading {
	...
	private final String MESSAGE_FAILURE = "加载失败,点击重试";
	...
	private void initializeViewContainer() {
		...
		Log.i("tag", height + "--------lyData.getLayoutParams().height");
		...
		// ViewSwitcher.LayoutParams layoutParams =new
		// ViewSwitcher.LayoutParams(
		// android.widget.FrameLayout.LayoutParams.MATCH_PARENT,
		// android.widget.FrameLayout.LayoutParams.MATCH_PARENT);
		// target.getmView().get
		// target.getmView().setLayoutParams(layoutParams);
	...
	private void setDefaultViews() {
		...
		ImageView mIvLoading = (ImageView) mLayoutLoadingContent
				.findViewById(R.id.iv_loading);
		final AnimationDrawable manimDrawable = (AnimationDrawable) mIvLoading
				.getDrawable();
