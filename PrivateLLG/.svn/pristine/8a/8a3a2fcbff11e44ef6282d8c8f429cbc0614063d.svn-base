...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		middle=AppContext.getScreenHeight()/2;
	}
...
//		 paint.setStrokeWidth(15);
		...
		//  左上角
		 ...
		 canvas.drawRect(frame.left,
		  frame.top, frame.left + 25,frame.top
		  + 10,
		  paint);
		...
		//  右上角
		 ...
		 canvas.drawRect(frame.right
		  - 10,
		  frame.top, frame.right,frame.top + 25,
		  paint);
...
//			paint.setAlpha(SCANNER_ALPHA[scannerAlpha]);
			paint.setAlpha(SCANNER_ALPHA[SCANNER_ALPHA.length-1]);
//			paint.setStrokeWidth(10);
			scannerAlpha = (scannerAlpha + 1) % SCANNER_ALPHA.length;
//			 middle = frame.height() / 2 + frame.top;
			 middle=middle+9;
			 int l=frame.top+frame.height();
