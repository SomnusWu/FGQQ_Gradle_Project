...
public class PersonSortAdapter extends BaseAdapter implements SectionIndexer{
	...
	public PersonSortAdapter(Context mContext, List<PersonSortMode> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<PersonSortMode> list){
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final PersonSortMode mContent = list.get(position);
		if (view == null) {
		...
		Log.i("tag", list.get(position).getName()+"=========name=====");
		return view;
