...
/**
 * 裁剪图片的Activity ，使用时在Manifest中注册添加
 * cn.zero.android.common.crop.CropImageActivity
 * 
 * @author Zero @date 2014年9月2日
 * @version 1.0
 */
@SuppressLint("NewApi")
...
//		findViewById(R.id.btn_roate).setOnClickListener(new OnClickListener() {
//
//			@Override
...
//					e.printStackTrace();
//				}
//				android.util.Log.i("tag", (is == null) + "=========is");
//				Bitmap bitmap = BitmapFactory.decodeStream(is);
//				android.util.Log.i("tag", (bitmap == null) + "=========bitmap");
//				newBitmap = rotateBitmapByDegree(bitmap, 90);
...
//		});
	...
	private void setupFromIntent() {
		...
		if (sourceUri != null) {
			...
			android.util.Log.i("tag", exifRotation + "=========exifRotation");
			try {
	...
	private void saveOutput(Bitmap mcroppedImage) {
		Bitmap croppedImage = null;
		if (saveUri != null) {
			OutputStream outputStream = null;
			try {
				croppedImage = rotateBitmapByDegree(mcroppedImage, exifRotation);
