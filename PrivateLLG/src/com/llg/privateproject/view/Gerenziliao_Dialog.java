...
public class Gerenziliao_Dialog extends Dialog implements
	...
	public interface AreaListener {
		/** 设置区域 */
		void setAddress(String area, String zone);
	}

	/** 监听选择配送时间和支付方式 */
	public interface PostTimeListener {
		void setPosttimeandPayment(String postTime, String payment);
	}

	/** 设置开发票类型 */
	public interface InvoiceListener {

		void setInvoice(String invoiceHead, String companyName,
						String invoiceType);
	...
	public interface PreferentialListener {
		void setPreferential(String coin, String voucher);
	}
	...
	public interface DianpufenleiListener {
		void setDianpufenlei(String one, String two);
