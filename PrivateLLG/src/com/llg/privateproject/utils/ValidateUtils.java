...
public class ValidateUtils {
	 ...
	 * 价格
	 */
	private static final String V_PRICE = "(0|[1-9][0-9]{0,9})(\\.[0-9]{1,2})?$";
	 ...
	 * 验证密码是否太简单
	 * @param pwd
	 * @return true:太简单，false:符合规则
	 * @增加人 xxs
	 * @增加日期 2016-3-9
	 */
	public static boolean isWeahPwd(String pwd){
		for (int i = 0; i < weakPwdArray.length; i++) {
			if(weakPwdArray[i].equals(pwd)){
				return true;
			}
		}
		return false;
