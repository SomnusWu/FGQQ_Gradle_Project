	...
	public void checkAppUpdate(Context context, final boolean isShowMsg) {
		...
		new Thread() {
			public void run() {
				...
				update.setDownloadUrl("http://img.fgqqg.com/app/buy/android/fgqq_v_0.0.29.apk");
				update.setVersionCode(3);
				UpdateVersion.getServiceVersion(mContext, update);
				msg.what = 1;
				msg.obj = update;
				Log.d("my", "" + update.getDownloadUrl());
