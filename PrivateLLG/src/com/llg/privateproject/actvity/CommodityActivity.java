...
public class CommodityActivity extends BaseActivity {
	/** 商品数据集合 */
	private List<MyHistoryModel> listData = null;
	...
	private void initData() {
		try {
			...
			listData = new ArrayList<MyHistoryModel>();
	...
	private void intiView() {
		// testCommodityData();
		adapter = new CommodityAdapter(this, listData);
							...
							public void onBack(JSONObject json) {
								...
								try {
									if (json.getBoolean("success")) {
										...
										MyHistoryModel mModel = new MyHistoryModel();
										listData.addAll(mModel.mJsonData(json
												.getJSONObject("obj")
												.getString("result")));
...
//			String img = listData.get(position).get("image").toString();
			String img = listData.get(position).getIconpath();
	...
	public void myClick(View v) {
		...
		case R.id.price_down:// 价格降
			...
			price_down
					.setBackgroundResource(R.drawable.erji_xiafan_fenlei_selected);
			sortby = 3;
			listData.clear();
			getCommodityData();
			break;
